...
echo ==================================
echo v1.0.2 20170328 将apktool升级到2.0.3, 最新的一个支持SmaliDebugging的版本，将jd-gui升级到1.4.0
echo https://connortumbleson.com/2015/12/31/apktool-v2-0-3-released/
...
echo .........apktool..........
java -jar "_tools\apktool\apktool-2.0.3.jar" d -d -f "%apkFile%"
echo .........dex2jar..........
